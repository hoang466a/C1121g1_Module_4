package com.huyhoang.demo.config;

import com.huyhoang.demo.service.Impl.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/admin","/blog/{id}/view").access("hasRole('ROLE_ADMIN')");
        ...
        http.authorizeRequests().and().formLogin()//
                ...
                .loginPage("/login")//
                .defaultSuccessUrl("/blog/list")//đây Khi đăng nhập thành công thì vào trang này. userAccountInfo sẽ được khai báo trong controller để hiển thị trang view tương ứng
